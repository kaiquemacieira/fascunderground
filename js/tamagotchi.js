...
(function () {
  ...
  var STAGES = [
    { id: 'ovo', minAgeH: 0, label: 'Ovo', sprite: '🥚' },
    { id: 'bebe', minAgeH: 1, label: 'Bebê', sprite: '🐣' },
    { id: 'filhote', minAgeH: 8, label: 'Filhote', sprite: '🐤' },
    { id: 'cria', minAgeH: 36, label: 'Cria', sprite: '🦊' },
    { id: 'festa', minAgeH: 96, label: 'Festeira', sprite: '🥁' },
    { id: 'adulta', minAgeH: 168, label: 'Roda', sprite: '🎭' },
    { id: 'ancia', minAgeH: 288, label: 'Anciã', sprite: '👑' }
  ];
  ...
  function spriteFace(s) {
    ...
    if (s.sick) return '🤒';
    return stageForAge(ageHours(s)).sprite;
  }
  function mood(s) {
  ...
  function render() {
    ...
    var face = $('tama-face');
    if (face) face.textContent = spriteFace(s);
    var name = $('tama-name');
