...
(function (global) {
  ...
  function ensureStyles() {
    ...
    s.textContent = [
      ...
      '.a11y-chip[aria-pressed="true"]{border-color:#C1523E;background:rgba(227,61,107,0.2);color:#fff}',
      ...
      'html[data-a11y-reading="focus"] :focus-visible{outline:3px solid #C1523E!important;outline-offset:3px!important}',
  ...
  function ensureUI() {
    ...
    toggle.style.cssText = [
      ...
      'border-radius:50%', 'border:2.5px solid #f2e8d2', 'background:#C1523E',
